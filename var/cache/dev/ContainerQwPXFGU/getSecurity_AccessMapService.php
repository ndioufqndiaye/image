...
$a = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/utili');
...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/depot'), [0 => 'ROLE_CASSIER'], NULL);
